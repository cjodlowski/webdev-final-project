        ...
        <div className="container mt-3">
            <div className="tab-content translations-content-item en visible" id="en">
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to CS4550 LLC, 360 Huntington Ave, Boston, MA 02115.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to WebDevFinalStore, accessible from <a href="webdevfinalstore.net" rel="external nofollow noopener" target="_blank">webdevfinalstore.net</a></p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By email: cs4550@northeastern.edu</li>
                </ul>
            </div>
        </div>
    )
